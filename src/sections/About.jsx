  ...
  return (
    <section id="about" className="py-20 bg-white dark:bg-gray-800 transition-colors duration-300" ref={ref}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl sm:text-5xl font-bold mb-4 dark:text-white">About Me</h2>
        ...
        >
          {skills.map((skill, index) => (
            <motion.div
              ...
              whileHover={{ y: -10 }}
              className="p-6 rounded-2xl bg-gradient-to-br from-gray-50 to-white dark:from-gray-700 dark:to-gray-700 shadow-lg hover:shadow-xl transition-shadow"
            >
              <div className="w-12 h-12 bg-accent/10 dark:bg-accent/20 rounded-xl flex items-center justify-center text-accent mb-4">
                {skill.icon}
              </div>
